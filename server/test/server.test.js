...
describe('PATCH /todos/:id', () => {
    it('should update the todo', (done) => {
        ...
        .send({
            completed:true,
            text           //text:text; since ES6 syntax it's just text
        })
        .expect(200)
        .expect((res) => {
    ...
    it('should not update the todo by other users', (done) => {
        var hexId = todos[0]._id.toHexString();
        var text = "This is a new text";
...
describe('POST /users', () => {
    it('should create a user', (done) => {
        var email = 'users1@example.com';       //give email which is not already in db
